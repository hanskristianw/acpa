...
<div class="container col-4 mt-4 p-3 mb-2 bg-light border border-primary rounded">
      ...
      <div class="alert alert-info mt-3 mb-4">
        <strong>Info: </strong> Pilih tanggal penerimaan rapor SEMESTER dan kepala sekolah.
      </div>
      ...
      <form method="POST" id="add-t-ajaran-form" action="rapot_waka/proses_terima_rapot.php">
          <div class="form-group mt-4">
              ...
              ?>
              <label>Kepala Sekolah (muncul pada rapor SEMESTER):</label>
              <select class="form-control form-control-sm mb-3" name="guru_id_option" id="guru_id_option">
                <?php echo $options;?>
              </select>
              
              <label>Guru Character Education (muncul pada rapor SEMESTER):</label>
              <select class="form-control form-control-sm mb-3" name="guru_id_option_bk" id="guru_id_option_bk">
                <?php echo $options;?>
              </select>
