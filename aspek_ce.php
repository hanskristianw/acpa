...
<div class="container col-6">
      ...
      <form method="POST" id="add-ssp-form" action="aspek_ce/add_aspek_ce.php">
          <div class="form-group">
              <h4 class="mb-4"><u>TAMBAH ASPEK CE</u></h4>
              
              <input type="text" name="aspek_nama" placeholder="Masukkan aspek CE" class="form-control form-control-sm mb-3" required>
              <textarea class="form-control form-control-sm mb-2" rows="5" name="aspek_a" id="comment" placeholder="Aspek Jika A"></textarea>
              <textarea class="form-control form-control-sm mb-2" rows="5" name="aspek_b" id="comment" placeholder="Aspek Jika B"></textarea>
              <textarea class="form-control form-control-sm mb-2" rows="5" name="aspek_c" id="comment" placeholder="Aspek Jika C"></textarea>
              <input type="submit" name="submit_ssp" class="btn btn-primary mt-3" value="Tambah ASPEK">
          </div>
      </form>
      </div >
