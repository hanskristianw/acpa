...
<div class="container col-6">
      ...
      <div class= "p-3 mb-2 bg-light border border-primary rounded">
          <div class="alert alert-danger alert-dismissible fade show">
            ...
            <strong>Info:</strong> Fitur ini berguna untuk rekap nilai topik apakah ada yang dobel!
          </div>
      <form method="POST" id="cek-topik-form" action="superadmin/cek_topik.php">
          <div class="form-group">
              <h4 class="mb-4"><u>CEK TOPIK dan NILAI</u></h4>
