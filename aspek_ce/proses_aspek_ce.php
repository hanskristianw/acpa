<?php
    ...
    if(isset($_POST['ce_id'])){
        ...
        echo "<h4 class='mb-3'>Update/Delete ASPEK</h4>";
        echo "<input type='text' placeholder='Masukkan aspek CE' rel='".$row['ce_id']."' class='form-control ce_nama mb-3' value='".$row['ce_aspek']."'>";
    ...
    if(isset($_POST['updatessp'])){
        ...
        $query_updatessp = "UPDATE ce SET ce_aspek = '$ce_nama', ce_a = '$ce_a', ce_b = '$ce_b', ce_c = '$ce_c' WHERE ce_id = $ce_id";
    ...
    $(document).ready(function(){
        ...
        $(".update").on('click', function(){
            ...
            if ($.trim(ce_nama).length === 0){
                ...
                $.post("aspek_ce/proses_aspek_ce.php",{ce_id: ce_id, ce_nama:ce_nama, ce_a:ce_a, ce_b:ce_b, ce_c:ce_c, updatessp: updatessp}, function(data){
