<?php
    if(isset($_POST['kelas_id'])){
        ...
        echo '<input type="checkbox" id="checkAll" class="checkAll"> <b>PILIH SEMUA</b> <br>';
        echo '<input type="hidden" value="0" name="nilssp">
              <input type="checkbox" id="nilssp" name="nilssp" value="1" checked> <b>TAMPILKAN NILAI SSP</b><hr/>';
