<?php
    ...
    if(isset($_POST['guru_id_option'])){
        ...
        $t_ajaran_bk_id_guru = $_POST['guru_id_option_bk'];
        
        $rawdate = htmlentities($_POST['tanggal_rapot']);
        $date = date('Y-m-d', strtotime($rawdate));
        
        $query2 = "UPDATE t_ajaran
                SET t_ajaran_kepsek_id_guru = $t_ajaran_kepsek_id_guru, t_ajaran_bk_id_guru = $t_ajaran_bk_id_guru, t_ajaran_tanggal_rapot = '$date'
