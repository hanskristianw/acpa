...
<?php
    if(isset($_POST['kelas_id'])){
        ...
        $query_updaterubrik = "UPDATE siswa SET siswa_komen = '$siswa_komen', siswa_absenin = $siswa_absenin, siswa_absenex = $siswa_absenex, siswa_tardy = $siswa_tardy, siswa_special_note = '$siswa_special_note' WHERE siswa_id = $siswa_id";
